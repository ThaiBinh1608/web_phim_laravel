...
<html lang="vi">
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
         ...
         <div class="container">
            <div class="row" id="headwrap">
               <div class="col-md-3 col-sm-6 slogan">
                  <p class=""><a href="" title="phim hay ">  <img class="" cl src="{{asset('uploads/logo/'.$infor->logo)}}" alt="">  </a></p>
            ...
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  <div class="footer-logo">
                     <img class="" cl src="{{asset('uploads/logo/'.$infor->logo)}}" alt=""> 
                  </div>
                  Liên hệ QC: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">[hakaioxyz@gmail.com]</a>
               </div>
            </div>
         </div>
      </footer>
      ...
      {{-- facebook --}}
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v19.0" nonce="FqDA4oy2"></script>
                     ...
                     $.getJSON('/json/movies.json',function(data){
                        $.each(data,function(key,value){
                           if(value.title.search(expression)!=-1){
                              $("#result").append('<li style="cursor:pointer; display: flex; width:100%; max-height: 200px;" class="list-group-item link-class"><img src="/uploads/movie/'+value.image+'" width="100" class="" /><div style="flex-direction: column; margin-left: 2px;"><h4 width="100%">'+value.title+'</h4><span style="display: -webkit-box; max-height: 8.2rem; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; white-space: normal; -webkit-line-clamp: 5; line-height: 1.6rem;" class="text-muted">| '+value.description+'</span></div></li>')
                           }
                        });
                     });
                  }
