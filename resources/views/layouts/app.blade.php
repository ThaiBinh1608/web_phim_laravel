            ...
            <div class="navbar-header">
              ...
              <h1>
                <a class="navbar-brand" href="{{url('/home')}}"
                  ><span class="fa fa-area-chart"></span> Zues<span
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li>
                      <a href="{{route('category.index')}}"
                        ><i class="fa fa-angle-right"></i> Quản lý danh mục</a
                      >
                    </li>
                  </ul>
                </li>
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li>
                      <a href="{{route('genre.index')}}"
                        ><i class="fa fa-angle-right"></i> Quản lý thể loại</a
                      >
                    </li>
                  </ul>
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li>
                      <a href="{{route('country.index')}}"
                        ><i class="fa fa-angle-right"></i> Quản lý quốc gia</a
                      >
                    </li>
                  </ul>
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li>
                      <a href="{{route('movie.index')}}"
                        ><i class="fa fa-angle-right"></i> Quản lý phim</a
                      >
                    </li>
                    <li>
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li>
                      <a href="{{route('episode.index')}}"
                        ><i class="fa fa-angle-right"></i> Quản lý tập phim</a
                      >
                    </li>
                  </ul>
                ...
                <ul class="dropdown-menu drp-mnu">
                  ...
                  <li>
                    ...
                    <form action="{{route('logout')}}" method="POST">
                      ...
                      <input type="submit" class="btn btn-danger btn-sm" value="Loguot">
                    </form>
                  </li>
                </ul>
              </li>
