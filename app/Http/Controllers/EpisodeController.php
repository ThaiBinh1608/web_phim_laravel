...
class EpisodeController extends Controller
{
    ...
    public function add_episode($id){
        ...
        $listserver = LinkMovie::orderBy('id','DESC')->get();
        $movie = Movie::find($id);
        $list_episode = Episode::with('movie')->where('movie_id',$id)->orderBy('episode','DESC')->get();
        
        return view('admin.episode.add',compact('list_episode','movie','linkmovie','listserver'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.episode.form',compact('episode','list_movie','linkmovie','listserver'));
    }
